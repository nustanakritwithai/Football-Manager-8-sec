...
// ---- Test 4+6: action variety + pass memory ตลอดแมตช์ ----
{
  ...
  // นาฬิกาแมตช์ 90 นาที: จบที่ 90:00 = 5400 วินาที พอดี
  assert(state.clock === 90 * 60, `clock ต้องจบที่ 90:00 (ได้ ${state.clock})`);
  assert(state.half === 2, 'ต้องเล่นถึงครึ่งหลัง');
